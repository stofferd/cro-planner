...
const updateLocalStorage = (id, newName) => {
            ...
            // get local storage
    const experiments = window.localStorage.getItem('experiments') ?  JSON.parse(window.localStorage.getItem('experiments')): [];
...
const Experiment = ({experiment: {id, name, score}, handleClick, expanded}) => {
